...
class tello():
    ...
    def pop_log(self):
        '''
        Receive current sensor information from drone
        :return: Current state of drone sensors @todo Add sensor details
        '''
        try:
            data, server = self.sock.recvfrom(1518)
        ...
        while 1:
            ...
            try:
                ...
                if (int(self.battery) < 30 and logged_battery_30 == 0):
                    print(
                        "WARNING: The Battery level of your Tello EDU is under 30 %. If it sinks under 20 %, the drone will land automatically")
                    logged_battery_30 = 1
                if (int(self.battery) < 20 and logged_battery_30 == 0):
                    print(
                        "WARNING: The Battery level of your Tello EDU is under 20 %. The drone stops and lands automatically.")
                    self.cmd("stop")
                    time.sleep(1)
                    self.cmd("land")
                    logged_battery_20 = 1
